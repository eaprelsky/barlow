    ...
    steps: [
      {
        ...
        say: 'Жми чип инструмента в шапке дорожки — библиотека звуков.',
        hint: 'Чип всегда под рукой: и в развёрнутой карточке, и в свёрнутой.',
        expect: 'click',
        side: 'bottom',
      },
      {
    ...
    steps: [
      {
        ...
        say: 'Жми «библиотека» — панель слева: инструменты и сэмплы.',
        expect: 'click',
        side: 'bottom',
      },
      {
        target: '[data-ob="inst-search"]',
        say: 'Поиск смотрит в имя, тембр и пояснение: «дабстеп» найдёт воббл.',
        side: 'bottom',
      },
      {
        target: '[data-ob="inst-cards"] .inst-card',
