...
export const GUIDES: Guide[] = [
  {
    ...
    steps: [
      ...
      { target: '[data-ob="instrument-layers"]', say: 'В «слоях» можно сложить основной голос и ещё три.', hint: 'Сначала настрой отдельный тембр и сохрани в «мои» — затем добавь его голосом. Уровень 0 выключает голос; частота × меняет отношение высот.' },
