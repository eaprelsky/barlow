...
export const GUIDES: Guide[] = [
  ...
  // ---- Отдельные умения ----
  {
    ...
    steps: [
      ...
      },
      {
        ...
        say: 'Переключай цель: громкость, фильтр или пан — у каждой своя кривая.',
        expect: 'click',
        side: 'top',
      },
      {
      ...
      {
        target: '[data-ob="mods-add"]',
        say: 'Жми «+ модуляция» — параметр поедет сам: LFO, ступени или перлин.',
      ...
      {
        target: '[data-ob="mods-list"] .mod-row',
        say: 'Цель — что качать; «синхр» — скорость по темпу. «→ в кривую» запечёт ход точками — правь руками.',
        side: 'top',
      },
    ],
  },
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        say: 'Режимы: прямой, гранулы, скрэтч — вкладка «сэмпл» редактора.',
        hint: 'Вкладка «сэмпл»: обрезка, разложение в гармоники, генерация.',
        side: 'bottom',
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        target: '[data-ob="sample-mode"]',
        say: 'На вкладке «сэмпл» поставь режим «скрэтч».',
        side: 'bottom',
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        say: 'Жми «править волну…» — перейдёшь к вкладкам волны и сэмпла.',
        expect: 'click',
        side: 'bottom',
      },
      {
        target: '[data-ob="we-tabs"]',
        say: 'Вкладки редактора: «волна» — свой тембр из гармоник, «сэмпл» — обрезка и разложение.',
        side: 'bottom',
      },
      {
      ...
      },
      {
        ...
        say: 'Жми «разложить в гармоники» — слепок уйдёт черновиком на вкладку «волна».',
        expect: 'click',
        side: 'bottom',
      },
      {
