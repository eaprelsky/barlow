...
export const GUIDES: Guide[] = [
  {
    ...
    steps: [
      ...
      { target: '[data-ob="envelope-mode"]', say: 'Режим «по точкам» позволяет нарисовать несколько атак и пауз.', hint: 'Готовая форма помогает начать. Время точки — процент длины ноты; обе крайние точки тихие. После гида попробуй «две атаки».' },
