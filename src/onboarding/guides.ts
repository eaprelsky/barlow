...
export const GUIDES: Guide[] = [
  {
    ...
    steps: [
      ...
      { target: '[data-ob="save-inst"]', say: 'Сохрани готовый инструмент в «мои».', hint: 'Весь состав голосов и их настройки сохранятся вместе; тоника написанной партии останется прежней.' },
    ],
  },
  {
    id: 'main',
