...
export const GUIDES: Guide[] = [
  {
    ...
    steps: [
      ...
      { target: '[data-ob="src-seg"]', say: 'Для синтеза выбери волну; для записи — сэмпл.', hint: 'Под волной доступны операторы/FM, движущиеся кадры wavetable и аналоговые формы VA.' },
