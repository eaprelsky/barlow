...
export function MainMenu({menus}:{menus:AppMenu[]}) {
 ...
 return <nav data-help="main-menu" className="main-menu" aria-label={msg("mainMenu.mainMenu")} ref={root} onKeyDown={e=>{
